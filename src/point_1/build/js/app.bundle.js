...
var Horse_1 = __webpack_require__(6754);

var Jockey_1 = __webpack_require__(2660);

var Race_1 = __webpack_require__(4057);

var Utils_1 = __webpack_require__(4938);
...
function () {
  function Form() {
    ...
    this.start = function () {
      ...
      var i = 0;
      (_a = _this.horseForm) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (e) {
        e.preventDefault();
        i = _this.registerHorse(i);
      });
      var raceIndex = 0;
      var horseIndex = 0;
      var race = new Race_1.Race();
      race.setId(parseInt((_b = document.getElementById('raceId')) === null || _b === void 0 ? void 0 : _b.value));
      (_c = _this.raceForm) === null || _c === void 0 ? void 0 : _c.addEventListener('submit', function (e) {
        var _a;
        ...
        if (horseIndex >= 4) {
          ...
          var race_1 = new Race_1.Race();
          race_1.setId(parseInt((_a = document.getElementById('raceId')) === null || _a === void 0 ? void 0 : _a.value));
          console.log(_this.raceList[raceIndex].getHorseWinner());

          _this.raceList[raceIndex].getHorseWinner().addWin();

          _this.raceList[raceIndex].getHorseWinner().getJockey().addWin();

          horseIndex = 0;
          raceIndex++;
        }

        if (_this.registerRace(race, raceIndex, horseIndex)) horseIndex++;
      });
    };

    this.registerHorse = function (i) {
      var _a;
      ...
      if (!_this.wasHorseAdded(i)) return i;
      (_a = _this.horseForm) === null || _a === void 0 ? void 0 : _a.reset();
      return ++i;
    };

    this.wasHorseAdded = function (i) {
      var _a, _b, _c, _d;

      var name = (_a = document.getElementById('horseName')) === null || _a === void 0 ? void 0 : _a.value;

      if (!Utils_1.Utils.isUnique(name, _this.horseList)) {
        alert('Nombre del caballo ya registrado');
        return false;
      } // Create new Horse object and add it to the list.


      var horse = new Horse_1.Horse();
      horse.setName(name);
      horse.setWeight(parseFloat((_b = document.getElementById('horseWeight')) === null || _b === void 0 ? void 0 : _b.value));
      horse.setAge(parseInt((_c = document.getElementById('horseAge')) === null || _c === void 0 ? void 0 : _c.value));
      horse.setBreed((_d = document.getElementById('horseBreed')) === null || _d === void 0 ? void 0 : _d.value); // console.log(horse);

      _this.horseList[i] = horse; // 1, 2, 3, 4 O(1)

      if (_this.horseList[i - 1] && horse.getAge() < _this.horseList[i - 1].getAge()) {
        Utils_1.Utils.quickSort(_this.horseList, 0, i);
      }

      _this.showHorsesList();

      return true;
    };

    this.showHorsesList = function () {
      // Rebuild dropdown section
      var options = document.querySelectorAll('#nameList option');
      options.forEach(function (o) {
        return o.remove();
      });
      var nameList = document.getElementById('nameList'); // Add to section tag

      _this.horseList.forEach(function (h) {
        var horseName = document.createElement('option');
        horseName.value = h.getName();
        horseName.innerHTML = h.getName();
        nameList === null || nameList === void 0 ? void 0 : nameList.appendChild(horseName);
      });
    };

    this.registerRace = function (race, raceIndex, horseIndex) {
      var _a;

      if (raceIndex > _this.limit) {
        alert('No se pueden registrar más carreras');
        return false;
      } else {
        if (!_this.addHorseToRace(race, raceIndex, horseIndex)) return false;
        (_a = _this.raceForm) === null || _a === void 0 ? void 0 : _a.reset();
        _this.raceId && (_this.raceId.value = raceIndex >= _this.limit ? 'Límite' : (raceIndex + 1).toString());
      }

      return true;
    };

    this.addHorseToRace = function (race, raceIndex, horseIndex) {
      var _a, _b, _c, _d; // Create horse


      var horse = Utils_1.Utils.findHorse((_a = document.getElementById('nameList')) === null || _a === void 0 ? void 0 : _a.value, _this.horseList); // Check if horse race log was already sended

      console.log("Race index: " + raceIndex);

      if (_this.raceList[raceIndex]) {
        if (!Utils_1.Utils.isUnique((horse === null || horse === void 0 ? void 0 : horse.getName()) || '', _this.raceList[raceIndex].getHorseList())) {
          alert("Ya se ha registrado la participaci\xF3n del caballo " + (horse === null || horse === void 0 ? void 0 : horse.getName()));
          return false;
        }
      }

      var jockey = new Jockey_1.Jockey((_b = document.getElementById('jockeyName')) === null || _b === void 0 ? void 0 : _b.value);
      horse === null || horse === void 0 ? void 0 : horse.setJockey(jockey);
      horse === null || horse === void 0 ? void 0 : horse.setDistance(parseFloat((_c = document.getElementById('distance')) === null || _c === void 0 ? void 0 : _c.value));
      horse === null || horse === void 0 ? void 0 : horse.setTime(parseFloat((_d = document.getElementById('time')) === null || _d === void 0 ? void 0 : _d.value));
      horse === null || horse === void 0 ? void 0 : horse.setSpeed((horse === null || horse === void 0 ? void 0 : horse.getDistance()) / (horse === null || horse === void 0 ? void 0 : horse.getTime()));
      console.log(horse);
      race.addHorseAt(horseIndex, horse || new Horse_1.Horse());
      Utils_1.Utils.selectWinners(horse || new Horse_1.Horse(), race);
      _this.raceList[raceIndex] = race;
      return true;
    };

    this.horseList = new Array(4);
    this.raceList = new Array(10);
    this.horseForm = document.getElementById('horseLog') || undefined;
    this.raceForm = document.getElementById('raceLog') || undefined;
    this.raceId = document.getElementById('raceId') || undefined;
    this.limit = 10;
  }
...
function () {
  ...
  Utils.isUnique = function (name, horseList) {
  ...
  Utils.findHorse = function (horseName, horseList) {
    for (var _i = 0, horseList_1 = horseList; _i < horseList_1.length; _i++) {
      var h = horseList_1[_i];
  ...
  Utils.selectWinners = function (horse, race) {
  ...
  Utils.arrayPartition = function (array, init, limit) {
    var j,
        swap,
        i = init - 1;
    var pivot = array[limit];
  ...
  Utils.quickSort = function (array, init, limit) {
    var partition_index;
...
function () {
  ...
  Competitor.prototype.getName = function () {
    return this.name;
  };

  Competitor.prototype.setName = function (name) {
    this.name = name;
  };

  Competitor.prototype.getWins = function () {
    return this.wins;
  };

  Competitor.prototype.addWin = function () {
    this.wins++;
  };
...
var Competitor_1 = __webpack_require__(2020);
...
function (_super) {
  ...
  function Horse() {
    ...
    _this.age = 0;
    _this.breed = '';
    _this.jockey = new Jockey_1.Jockey();
    _this.speed = 0;
    _this.distance = 0;
    _this.time = 0;
    return _this;
  ...
  Horse.prototype.getWeight = function () {
    return this.weight;
  };
  ...
  Horse.prototype.getAge = function () {
    return this.age;
  };

  Horse.prototype.setAge = function (age) {
    this.age = age;
  };

  Horse.prototype.getBreed = function () {
    return this.breed;
  };

  Horse.prototype.setBreed = function (breed) {
    this.breed = breed;
  };

  Horse.prototype.getJockey = function () {
    return this.jockey;
  };

  Horse.prototype.setJockey = function (jockey) {
    this.jockey = jockey;
  };

  Horse.prototype.getSpeed = function () {
    return this.speed;
  };

  Horse.prototype.setSpeed = function (speed) {
    this.speed = speed;
  };

  Horse.prototype.getDistance = function () {
    return this.distance;
  };

  Horse.prototype.setDistance = function (distance) {
    this.distance = distance;
  };

  Horse.prototype.getTime = function () {
    return this.time;
  };

  Horse.prototype.setTime = function (time) {
    this.time = time;
  };
...
function () {
  function Race() {
    this.id = 0;
    this.horseList = new Array(4);
    this.horseWinner = new Horse_1.Horse();
    this.secondPlace = new Horse_1.Horse();
    this.jockeyWinner = new Jockey_1.Jockey();
  }
  ...
  Race.prototype.setId = function (id) {
    this.id = id;
  };

  Race.prototype.addHorseAt = function (index, horse) {
    this.horseList[index] = horse;
  };

  Race.prototype.getHorseList = function () {
    return this.horseList;
  };

  Race.prototype.getHorseAt = function (index) {
    return this.horseList[index];
  };

  Race.prototype.getHorseWinner = function () {
    return this.horseWinner;
  };

  Race.prototype.setHorseWinner = function (horseWinner) {
    this.horseWinner = horseWinner;
  };

  Race.prototype.getSecondPlace = function () {
    return this.secondPlace;
  };

  Race.prototype.setSecondPlace = function (secondPlace) {
    this.secondPlace = secondPlace;
  };

  Race.prototype.getJockeyWinner = function () {
    return this.jockeyWinner;
  };

  Race.prototype.setJockeyWinner = function (jockeyWinner) {
...
var Form_1 = __webpack_require__(1997);
...
var main = function main() {
  ...
  (_a = document.getElementById('horseLog')) === null || _a === void 0 ? void 0 : _a.reset();
  (_b = document.getElementById('raceLog')) === null || _b === void 0 ? void 0 : _b.reset();
  document.getElementById('raceId').value = '1';
  form.start();
};
